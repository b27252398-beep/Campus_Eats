        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    <Link to="/canteen/scan-qr" className="group bg-gradient-to-br from-green-500 to-teal-500 rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all transform hover:-translate-y-1 text-left block">
                        ...
                        <p className="text-white/90">Verify customer orders for pickup</p>
                    </Link>
                    ...
                    <Link to="/canteen/kitchen" className="group bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all transform hover:-translate-y-1 text-left block">
                    ...
                    <Link to="/canteen/orders" className="group bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all transform hover:-translate-y-1 text-left block">
