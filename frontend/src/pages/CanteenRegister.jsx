        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 py-8 px-4">
            <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-gray-900">Register Your Canteen</h1>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {step === 1 && (
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Alternative Contact (Optional)</label>
                    ...
                    {step === 2 && (
                        <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Room/Shop Number</label>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Landmark/Directions</label>
                            ...
                            <div>
                                ...
                                <textarea name="description" value={formData.description} onChange={handleChange} required rows="4"
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500"></textarea>
                            </div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Specialty Items</label>
                    ...
                    {step === 3 && (
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Average Preparation Time (minutes)</label>
                            ...
                            <div className="border-t pt-6 mt-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">Food Safety License</label>
                    ...
                    <div className="flex justify-between mt-8">
                        ...
                        {step < 4 ? (
                            ...
                            <button type="submit" disabled={loading}
                                className="ml-auto px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold disabled:opacity-50">
