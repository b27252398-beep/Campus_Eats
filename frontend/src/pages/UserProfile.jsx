        ...
        <div className="min-h-screen bg-[#0a0a0a]">
                                                        ...
                                                        <div className="bg-gradient-to-r from-amber-600/10 to-orange-600/10 border-b border-white/[0.06] px-6 py-4">
                                                            <div className="flex justify-between items-start flex-wrap gap-3">
                                                                <div>
                                                                    ...
                                                                    <p className="text-white/30 text-xs mt-1">{formatDate(review.createdAt)}{review.updatedAt && review.updatedAt !== review.createdAt && <span className="text-orange-400/50 ml-1.5">(edited)</span>}</p>
                                                                </div>
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <div className="flex gap-1">
                                                                        <button
                                                                            onClick={() => { setEditingReview(review); setEditModalOpen(true) }}
                                                                            className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/5 border border-white/10 text-white/30 hover:text-orange-400 hover:bg-orange-500/10 hover:border-orange-500/20 transition-all"
                                                                            title="Edit review"
                                                                        >
                                                                            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            ...
                                                            {deleteConfirmId === review.id && (
                                                                <div className="mt-3 bg-red-500/10 border border-red-500/20 rounded-xl p-3 flex items-center justify-between gap-3">
                                                                    <p className="text-red-400 text-xs font-medium">Delete this review? This cannot be undone.</p>
                                                                    <div className="flex gap-2 flex-shrink-0">
                                                                        <button
                                                                            onClick={() => setDeleteConfirmId(null)}
                                                                            disabled={deleting}
                                                                            className="px-3 py-1.5 bg-white/5 border border-white/10 text-white/50 rounded-lg text-xs font-bold hover:bg-white/10 transition-all disabled:opacity-50"
                                                                        >
                                                                            Cancel
                                                                        </button>
                                                                        <button
                                                                            ...
                                                                            disabled={deleting}
                                                                            className="px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-xs font-bold transition-all disabled:opacity-50 flex items-center gap-1.5"
                                                                        >
                                                                            {deleting ? (
            ...
            {editingReview && (
                <ReviewModal
                    ...
                    onClose={() => { setEditModalOpen(false); setEditingReview(null) }}
                    existingReview={editingReview}
                    onReviewSubmitted={() => { fetchReviews(); setEditModalOpen(false); setEditingReview(null) }}
                />
            )}
